...
class Log {
  ...
  askForReport(): void {
    console.info(
      'The following error is a bug. Please open an issue on the foxfork issue structure with a link to your repository and the output from this command.'
    )
    console.info(
      'The foxfork issue tracker is located at: https://github.com/binary-blazer/foxfork/issues'
    )
  }
}
